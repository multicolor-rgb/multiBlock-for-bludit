...
<input type="text" required placeholder="<?php echo $L->get("category-place-holder");?>" class="mb_title" name="categoryname" value="<?php echo str_replace('-',' ',@$_GET['categoryname']);?>">
<input type="hidden" id="jstokenCSRF" name="tokenCSRF" value="<?php echo $tokenCSRF;?>">
